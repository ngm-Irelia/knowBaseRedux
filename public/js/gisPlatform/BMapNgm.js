...
(function() {
    ...
    function bMapNgm() {
      ...
      //显示重点区域
      function addKeyArea(){
            const url = '/object/getKeyAreaGisList';
            let data = null;
      ...
      window.mapOwnFun = {
          ...
          mapSaveTopoMenu:function(thisMarker){
            //发送请求获得gis字段名称
            $.get('/object/gis/property', {objectType: thisMarker.type}, function (reData) {
              if (!reData) {
                return false;
              }
              ...
              $.post('/object/detailInformation', {modifyJson: JSON.stringify(editObject), id: thisMarker.id, type: thisMarker.type}, function (data) {
                if (!data) {
                  return false;
                }
          ...
          mapClickAreaSearchMenu:function(sign){
              ...
              if(clickArea.type=="circle"){
                  ...
                  areaurl = '/object/areaSearch/saveCircleGis';
                  ...
                  areaurl = '/object/areaSearch/savePolygonGis';
              }
          ...
          mapClickKeyAreaMenu:function(type, sign){
              ...
              if(type === "delete"){
                  const url = '/object/deleteKeyArea';
